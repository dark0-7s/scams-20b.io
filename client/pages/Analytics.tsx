...
const departmentStats = [
  { name: 'Computer Science', students: 320, avgAttendance: 91, courses: 24, satisfaction: 4.8 },
  { name: 'Electronics', students: 285, avgAttendance: 87, courses: 20, satisfaction: 4.6 },
  { name: 'Mechanical', students: 298, avgAttendance: 89, courses: 22, satisfaction: 4.7 },
...
const subjectPerformance = [
  ...
  { subject: 'Database Systems', attendance: 89, engagement: 85, resources: 12, difficulty: 'Medium' },
  { subject: 'Computer Networks', attendance: 85, engagement: 82, resources: 18, difficulty: 'High' },
  { subject: 'Software Engineering', attendance: 87, engagement: 89, resources: 14, difficulty: 'Medium' },
  { subject: 'Algorithms', attendance: 90, engagement: 91, resources: 16, difficulty: 'High' }
];
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex space-x-1 mt-2">
              {[1,2,3,4,5].map((star) => (
                <div key={star} className={`w-3 h-3 rounded-full ${star <= 4 ? 'bg-yellow-400' : 'bg-gray-200'}`} />
              ))}
            </div>
          </CardContent>
        </Card>
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Monthly attendance patterns across departments</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <LineChart data={attendanceTrends}>
                    ...
                    <Line type="monotone" dataKey="cs" stroke="#10b981" strokeWidth={2} />
                    <Line type="monotone" dataKey="ece" stroke="#f59e0b" strokeWidth={2} />
                    <Line type="monotone" dataKey="mech" stroke="#ef4444" strokeWidth={2} />
                    <Line type="monotone" dataKey="civil" stroke="#8b5cf6" strokeWidth={2} />
                  </LineChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Attendance and engagement by class time</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-center">
                      <div>
                        <div className="text-2xl font-bold text-primary">{dept.avgAttendance}%</div>
                        <p className="text-xs text-muted-foreground">Attendance</p>
                      </div>
                      <div>
                        <div className="text-2xl font-bold text-yellow-600">{dept.satisfaction}</div>
        ...
        <TabsContent value="subjects" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Detailed breakdown by subject and course</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="overflow-x-auto">
                <table className="w-full">
                      ...
                      <tr key={index} className="border-b hover:bg-muted/50">
                        ...
                        <td className="p-3">
                          <div className="flex items-center space-x-2">
                            ...
                            <Progress value={subject.engagement} className="w-16 h-2" />
                          </div>
                        </td>
                        <td className="p-3">{subject.resources} files</td>
                        <td className="p-3">
                          <Badge variant={
                            subject.difficulty === 'High' ? 'destructive' :
        ...
        <TabsContent value="engagement" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>How students interact with learning materials</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {resourceEngagement.map((resource, index) => (
                  <div key={index} className="p-4 border rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Badge variant="outline">{resource.engagement}% engaged</Badge>
                    </div>
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        <span>Usage</span>
                        <span className="font-medium">
                          {resource.downloads || resource.views || resource.attempts}
                        </span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span>Avg. Time</span>
              ...
              <CardContent className="space-y-4">
                <div className="p-3 rounded-lg bg-green-50 border border-green-200">
                  ...
                  <p className="text-sm text-green-700">
                    Overall attendance has improved by 5.2% this semester compared to last semester.
                  </p>
                </div>
                ...
                <div className="p-3 rounded-lg bg-yellow-50 border border-yellow-200">
                  ...
                  <p className="text-sm text-yellow-700">
                    Afternoon classes (3-5 PM) show 12% lower attendance rates than morning classes.
                  </p>
                </div>
                ...
                <div className="p-3 rounded-lg bg-blue-50 border border-blue-200">
                  ...
                  <p className="text-sm text-blue-700">
                    Video resources have 92% engagement rate - consider creating more video content.
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium">Optimize Class Scheduling</p>
                      <p className="text-xs text-muted-foreground">
                        Consider moving high-priority subjects to morning slots for better attendance.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Create more video tutorials for subjects with lower engagement rates.
                      </p>
                    </div>
                  </div>
                </div>
